import Languages from "./skills/languages.mdx?inline";
import Platforms from "./skills/platforms.mdx?inline";
import Frameworks from "./skills/frameworks.mdx?inline";
import Database from "./skills/database.mdx?inline";
import Orm from "./skills/orm.mdx?inline";
import LibsAndProtocols from "./skills/libs-and-protocols.mdx?inline";
